...
const CACHE = 'releve-smur-v0.6.0-p0-20260717';
...
const CORE_ASSETS = [
  ...
  './src/data/reference.js', './src/data/source-manifest.js', './src/data/operational-assets.js', './src/data/demo-fixtures.js', './src/data/chariot-reference.json', './src/data/visual-schemas.js',
