const ASSET_ROOT = './public/assets/chariots/box-3-4-adulte';
const ITEM_ROOT = `${ASSET_ROOT}/tiroir-01/items`;
const LOCATION = 'Tiroir 1 · Intubation';

function positionedItem({ id, name, specification = '', category, file, x, y, width, aspectRatio, zIndex }) {
  return {
    id,
    name,
    specification,
